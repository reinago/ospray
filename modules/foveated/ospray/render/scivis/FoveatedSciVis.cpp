...
FoveatedSciVis::FoveatedSciVis()
{
  ispcEquivalent = ispc::FoveatedSciVis_create(this);
}

std::string FoveatedSciVis::toString() const
{
  return "ospray::render::FoveatedSciVis";
}

void FoveatedSciVis::commit()
{
  FoveatedRenderer::commit();
...
void *FoveatedSciVis::beginFrame(FrameBuffer *, World *world)
{
  if (!world)
    return nullptr;
