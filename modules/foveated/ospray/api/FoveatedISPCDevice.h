...
#include "../render/FoveatedLoadBalancer.h"

namespace ospray {
namespace foveated {

struct FoveatedISPCDevice : ospray::api::ISPCDevice
{
  FoveatedISPCDevice() : loadBalancer(std::make_shared<FoveatedLoadBalancer>()) {}
 // virtual ~FoveatedISPCDevice() override;
